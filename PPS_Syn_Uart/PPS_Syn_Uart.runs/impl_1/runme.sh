...
HD_PWD='E:/PPS_Syn/PPS_Syn_Uart/PPS_Syn_Uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PPS_delay_Uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PPS_delay_Uart.tcl -notrace
