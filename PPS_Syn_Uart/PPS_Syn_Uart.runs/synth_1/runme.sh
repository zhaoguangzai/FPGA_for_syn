...
HD_PWD='E:/PPS_Syn/PPS_Syn_Uart/PPS_Syn_Uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PPS_delay_Uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PPS_delay_Uart.tcl
